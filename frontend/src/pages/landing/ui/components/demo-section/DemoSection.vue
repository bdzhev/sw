...
<template>
  <section
    class="
      grid h-screen max-w-full grid-flow-row auto-rows-min grid-cols-6 gap-4
      px-20 pt-30
    "
  >
    <div
      class="col-span-6 row-span-1 font-alegreya text-7xl font-extrabold italic"
    >
    ...
    <DemoResultCard class="col-span-3 row-span-2"/>
  </section>
</template>
